...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SMS.Models.Invitation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SMS.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SMS.Models.SMSUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SMS.Models.SMSUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SMS.Models.Event", b =>
                {
                    b.HasOne("SMS.Models.EventCategory", "Category")
                        .WithMany("Events")
            ...
            modelBuilder.Entity("SMS.Models.Invitation", b =>
                {
                    ...
                    b.HasOne("SMS.Models.SMSUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
